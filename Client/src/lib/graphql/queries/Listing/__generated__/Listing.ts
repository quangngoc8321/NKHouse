...
export interface Listing_listing_review_user {
  __typename: "User";
  id: string;
  avatar: string;
}

export interface Listing_listing_review {
  __typename: "Review";
  user: Listing_listing_review_user;
  name: string;
  rating: number;
  comment: string;
}
...
export interface Listing_listing {
  ...
  salepercent: number;
  numofReview: number;
  review: (Listing_listing_review | null)[] | null;
}
