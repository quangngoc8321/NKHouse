...
export const UserBookings = ({
  ...
  const userBookingsList = userBookings ? (
    <List
      ...
      locale={{ emptyText: "Bạn chưa đặt nhà/phòng nào!" }}
      pagination={{
        position: "top",
  ...
  const userBookingsElement = userBookingsList ? (
    <div className="user-bookings">
      ...
      <Paragraph className="user-bookings__description">
        Phần này nêu bật các đặt phòng bạn đã thực hiện và ngày nhận phòng / trả
        phòng liên quan đến các đặt phòng nói trên.
      </Paragraph>
      {userBookingsList}
    </div>
  ) : null;
